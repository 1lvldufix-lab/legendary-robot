...
sys.path.insert(0, os.path.join(ROOT, "тесты"))
...
from эталоны import ЭТАЛОНЫ  # noqa: E402
...
gt1 = ЭТАЛОНЫ["photo_1_2026-09-24_19-49-40.jpg"]   # temiyy 2:3 Rusli
p1 = parsed_from(gt1)
r = rm.resolve(p1, 801)
...
gt_b = ЭТАЛОНЫ["photo_1_2026-09-24_19-49-50.jpg"]   # вариант Б: quete-основа 3:1 KadyrFc
