"""ГЕЙТ БЛОКА 5: 11 эталонов «Нова тека» прогнаны через OCR-конвейер (промпт,
...
MockProvider с ground truth из эталоны.py — проверяется ВЕСЬ конвейер после
...
from эталоны import ЭТАЛОНЫ, ПАЧКИ
...
for pack in ПАЧКИ:
    gt = {f: ЭТАЛОНЫ[f] for f in pack["files"]}
...
gt = ЭТАЛОНЫ["photo_2_2026-09-24_19-49-40.jpg"]  # 3:3, пен 5:4, 6 голов
